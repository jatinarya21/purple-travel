            ...
            <nav className='container mx-auto px-3 lg:px-20.5 2xl:px-44'>
                <div className='flex items-center justify-between py-5'>
                    ...
                    <div className='flex lg:gap-12 xl:gap-32 2xl:gap-0 justify-between 2xl:w-[62%]'>
                        ...
                        <a className='font-jakarta font-bold text-base leading-5 py-[13.5px] px-[29px] bg-purple_custom border-2 transition-all border-[#872BFF] rounded-3xl text-white hidden lg:block hover:bg-transparent hover:text-[#872BFF]' href="#">Sign Up</a>
                    </div>
                </div>
            </nav>
            {/* hero section */}
            <div id='home' className='pt-9'>
                <div className=" container mx-auto px-3 2xl:px-28 relative">
                    ...
                    <div className='flex  justify-center '>
                        <h1 className='font-jakarta font-bold min-[576px]:text-[40px] text-3xl md:text-4xl lg:text-5xl xl:text-[64px] 2xl:text-[70px] text-center xl:!leading-[80.6px] w-[80%] sm:w-[50%] lg:w-[50%] xl:w-[57%]'>From Southeast Asia <span className='text-secondary'>To The World</span></h1>
                    </div>
                    <div className="flex flex-wrap gap-5 xl:gap-0 justify-center items-center pt-12 relative">
                        ...
                        <div className='w-5/12 sm:w-3/12 md:w-1.5/12 xl:w-2/12 hidden sm:block xl:pl-9 xl:pr-2'>
                            <div className='flex flex-col items-end xl:mr-2 gap-4 xl:gap-[18px]'>
                        ...
                        <div className='w-5/12 sm:w-3/12 md:w-3.5/12 xl:w-4/12 relative flex justify-center'>
                            <div className='bg-[#872BFF] rounded-full absolute -top-8 left-0   2xl:-top-8   2xl:left-5 overflow-hidden'>
                                <span className='absolute z-5 left-[26px] top-[15px] sm:left-[50px]  sm:top-[50px]'><svg className='w-[17px]  sm:w-[34px]' width="34" height="34" viewBox="0 0 26 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <svg id="rotatingText" className='fill-white w-[70px] h-[70px] sm:w-[100px] sm:h-[100px] lg:w-[140px] lg:h-[140px]' viewBox="0 0 200 200" width="140" height="140">
                                    <defs>
                ...
                ">
                        ...
                        <div className='w-5/12 sm:w-7/12 md:w-1.5/12 xl:w-2/12 sm:hidden  md:block xl:pr-9 xl:pl-2'>
                            <div className='flex flex-row md:flex-col justify-around xl:ml-2  gap-4 xl:gap-[18px]'>
