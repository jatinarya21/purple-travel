    ...
    return (
        <div className='py-1 md:py-12 xl:py-[120px] relative'>
            ...
            <div className="container mx-auto px-3 md:px-20.5 relative z-[1]">
                ...
                <p className='text-secondary font-jakarta font-bold md:text-xl text-center uppercase tracking-[5px]'>Easy and Fast</p>
                <h1 className='font-jakarta text-2xl sm:text-3xl md:text-5.5xl text-center font-bold mt-3.5'>Choose Tour & Travel Types</h1>
                <div className="flex flex-wrap xl:gap-6 pt-4 md:pt-10 xl:pt-14">
                    <div className='w-full sm:w-6/12 mt-4 md:mt-0 lg:mt-4 lg:px-3 xl:px-0 xl:mt-0 xl:w-[23.4%] min-[576px]:px-16 md:px-3'>
                    ...
                    <div className='w-full sm:w-6/12 mt-4 md:mt-8 lg:mt-4 lg:px-3 xl:px-0 xl:mt-0 xl:w-[23.4%] min-[576px]:px-16 md:px-3'>
                        <div className='pt-11 pb-10 px-16 flex flex-col items-center rounded-3xl cursor-pointer bg-white hover:bg-linear-gradient group transition-all duration-300 ease-in-out shadow-[0px_4px_16px_0px_#00000018]'>
