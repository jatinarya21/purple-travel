                        ...
                        <div className='lg:w-[40.5%] flex flex-col justify-center md:items-center lg:items-start'>
                            <div className='flex flex-col justify-center items-start md:items-center lg:items-start'>
                                <span className='flex items-center  gap-5'>
                                    <a href="#"><img className='w-[40px] md:w-[70px]' width={70} height={70} src={FooterCompanyLogo} alt="Company-logo" /></a>
                                    <p className='font-jakarta font-bold text-xl md:text-[42px] text-white '>Travel</p>
                                </span>
                            ...
                            <div className='mt-[18px]'>
                                ...
                                <div className='flex items-center  gap-3.5 mt-3.5'>
                                    <a href="https://in.linkedin.com/" target='_blank' className='transition-all duration-500 hover:-translate-y-1'><FooterLinkedin /> </a>
                                    <a href="https://www.instagram.com/?hl=en" target='_blank' className='transition-all duration-500 hover:-translate-y-1' ><FooterInstagram /></a>
                                    <a href="https://www.facebook.com/" target='_blank' className='transition-all duration-500 hover:-translate-y-1' > <FooterFacebook /> </a>
                                    <a href="https://twitter.com/?lang=en" target='_blank' className='transition-all duration-500 hover:-translate-y-1' > <FooterTwitter /> </a>
                                </div>
                            </div>
                        </div>
                        <div className='w-[55%] lg:w-5/12 flex flex-col justify-center   lg:justify-end sm:flex-row mt-5  '>
                            ...
                            <div className="  sm:w-6/12 pt-3 md:pt-0">
                                ...
                                <ul className='pt-1 md:pt-4 flex flex-col gap-5'>
