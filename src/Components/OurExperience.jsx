...
const OurExperience = () => {
    return (
        <div className='pb-12 xl:pb-[120px] relative'>
            ...
            <img src={PinkStar} className='absolute bottom-14 md:bottom-52 right-9' alt="Star" />
            <div className="container mx-auto lg:px-20.5">
                <div className="flex flex-wrap justify-center lg:justify-between">
                    ...
                    <div className='lg:w-[45%] pt-[53px]'>
                        <p className='text-secondary font-jakarta font-bold text-xl text-center lg:text-start tracking-widest uppercase'>our experience</p>
                        <h3 className='font-jakarta text-black font-bold mt-3.5 text-center lg:text-start text-2xl md:text-5.5xl leading-[130%]'>Open the Door to Your Dream Destination</h3>
